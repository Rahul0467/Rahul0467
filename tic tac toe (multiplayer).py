...
def checkwin():
    ...
    if b1["text"] == "X" and b2["text"] == "X" and b3["text"] == "X":
        ...
        b3.config(bg="green")
        winner = True
        messagebox.showinfo("Tic Tac Toe", "X are the winner!!")
        disable_all_buttons()
        ...
        b3.config(bg="green")
        winner = True
        messagebox.showinfo("Tic Tac Toe", "O are the winner!!")
        disable_all_buttons()
...
def b_click(b):
    ...
    if b["text"] == " " and clicked == True:
        ...
        messagebox.showinfo("Tic Tac Toe", "Hey! that box is already been selected \n Pick another box")
